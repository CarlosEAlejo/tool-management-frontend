...
export const ToolForm = ({ value = EMPTY_TOOL_FORM, mode, onChange }) => {
  ...
  return (
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
      ...
      {isDamaged ? (
        <CheckboxField label="Deterioro" name="deterioration" checked={value.deterioration} onChange={handleChange} />
      ) : null}
